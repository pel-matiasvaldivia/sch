export default function SettingsPage() {
  return (
    <div className="flex flex-col items-center justify-center h-full text-center p-8 bg-white rounded-2xl shadow-sm border border-gray-100">
      ...
      <p className="text-gray-500 max-w-md"> Esta sección se encuentra actualmente en desarrollo. Pronto podrás configurar los parámetros generales del sistema. </p>
    </div>
  );
}
